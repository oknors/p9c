...
${``}`;
  ...
  function init(settings = default_settings) {
    ...
    options = {
      ...
      dev: false,
      entry: {
        file: assets + "/_app/start-ceb264e2.js",
        css: [],
        js: [assets + "/_app/start-ceb264e2.js", assets + "/_app/chunks/vendor-633de1bb.js"]
      },
      fetched: void 0,
      floc: false,
  ...
  var Where = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    return `<div class="${"flex flex-col text-center parallelcoin"}">rrrrr
      ...
      default: () => `Where is ParallelCoin???`
        ...
        <div class="${"my-24 worp"}"><amp-list layout="${"responsive"}" width="${"600"}" height="${"300"}" src="${"https://api-parallelcoin-io.cdn.ampproject.org/c/s/api.parallelcoin.io/subs"}" reset-on-refresh single-item items="${"."}" binding="${"no"}">${escape(`{{ . }}`)}
