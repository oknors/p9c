...
${``}`;
  ...
  function init(settings = default_settings) {
    ...
    options = {
      ...
      dev: false,
      entry: {
        file: assets + "/_app/start-74905886.js",
        css: [],
        js: [assets + "/_app/start-74905886.js", assets + "/_app/chunks/vendor-2231b500.js"]
      },
      fetched: void 0,
      floc: false,
...
<div id="${"layout"}" class="${"relative flex flex-col items-center justify-between min-h-screen antialiased font-text text-text-primary "}">${validate_component(Bg, "Bg").$$render($$result, {}, {}, {})}
  ...
  var css$1 = {
    code: "p.svelte-1jb77hl{margin:0 auto\n}",
    map: `{"version":3,"file":"Download.svelte","sources":["Download.svelte"],"sourcesContent":["<script>\\n      import HeadTitle from '$lib/components/HeadTitle.svelte';\\n      import Socials from '$lib/components/Socials.svelte';\\n      import ButtonZoom from '$lib/components/Socials.svelte';\\n<\/script>\\n<div class=\\"flex flex-col text-center parallelcoin\\">rrrrr\\n\\n            <amp-list layout=\\"responsive\\" width=\\"600\\" height=\\"300\\" src=\\"https://api.parallelcoin.info/downloads\\" reset-on-refresh single-item items=\\".\\"\\n                  binding=\\"no\\">\\n                  {\`{{ . }}\`}\\n            <template type=\\"amp-mustache\\">\\n  <a class=\\"flex flex-row justify-center my-4 text-2xl no-underline text-text-primary\\" href=\\"{\`'https://'{{ slug }}'.parallelcoin.info'\`}\\">\\n            <div class=\\"character\\">{\`{{ title }}\`}</div>\\n            <div class=\\"flex-grow hidden mx-1 mb-2 border-b-2 border-dotted md:flex\\"></div>\\n            <div class=\\"hidden md:flex\\">{\`{{ slug }}\`}.parallelcoin.info</div>\\n          </a>\\n        </template>\\n        </amp-list>\\n\\n\\n\\n\\n    <main class=\\"flex flex-col items-center text-text-primary\\">\\n          <h2 class=\\"text-3xl text-center\\">ParallelCoin wallet application</h2>\\n            <p class=\\"flex flex-wrap justify-center\\">\\n                <ButtonZoom icon=release.CustomFields.Icon :title=release.Title :desc=release.Content :url=\\"release.CustomFields.URL\\" :key=\\"release.Slug\\"></ButtonZoom>\\n            </p>\\n            <p class=\\"flex flex-wrap justify-center\\">\\n                <ButtonZoom icon=release.CustomFields.Icon :title=release.Title :desc=release.Content :url=\\"release.CustomFields.URL\\" :key=\\"release.Slug\\"></ButtonZoom>\\n            </p>\\n            <br />\\n            <h3 class=\\"text-2xl text-center\\">ParallelCoin legacy wallet application</h3>\\n            <p class=\\"flex flex-wrap justify-center\\">\\n                <ButtonZoom icon=legacy.CustomFields.Icon :title=legacy.Title :desc=legacy.Content :url=\\"legacy.CustomFields.URL\\" :key=\\"legacy.Slug\\"></ButtonZoom>\\n            </p>\\n            <p class=\\"flex flex-wrap justify-center\\">\\n                <ButtonZoom icon=legacy.CustomFields.Icon :title=legacy.Title :desc=legacy.Content :url=\\"legacy.CustomFields.URL\\" :key=\\"legacy.Slug\\"></ButtonZoom>\\n            </p>\\n    </main>\\n</div>\\n\\n\\n<style>\\nbody > div{\\n  background-image: url(https://s.okno.rs/parallelcoin/img/detectivzombi.png),url(https://s.okno.rs/img/go/crash-dummy.svg);\\n  background-repeat: no-repeat;\\n  background-position: center bottom,left bottom;\\n}\\n.stage {\\n  width: 100%;\\n  height: 100%;\\n  box-sizing: border-box;\\n  max-width: 100%;\\n}\\n\\n\\np{\\n  margin:0 auto\\n}\\n#loading {\\n  background-color: #303030;\\n  color: #cfcfcf;\\n  font-size: 32px;\\n  padding-top: 10vh;\\n  height: 100vh;\\n  text-align: center;\\n}\\n</style>"],"names":[],"mappings":"AAwDA,gBAAC,CAAC,AACA,OAAO,CAAC,CAAC,IAAI;AACf,CAAC"}`
  };
  var Download = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    $$result.css.add(css$1);
    return `<div class="${"flex flex-col text-center parallelcoin"}">rrrrr

            <amp-list layout="${"responsive"}" width="${"600"}" height="${"300"}" src="${"https://api.parallelcoin.info/downloads"}" reset-on-refresh single-item items="${"."}" binding="${"no"}">${escape(`{{ . }}`)}
            <template type="${"amp-mustache"}"><a class="${"flex flex-row justify-center my-4 text-2xl no-underline text-text-primary"}"${add_attribute("href", `'https://'{{ slug }}'.parallelcoin.info'`, 0)}><div class="${"character"}">${escape(`{{ title }}`)}</div>
            <div class="${"flex-grow hidden mx-1 mb-2 border-b-2 border-dotted md:flex"}"></div>
            <div class="${"hidden md:flex"}">${escape(`{{ slug }}`)}.parallelcoin.info</div></a></template></amp-list>




    <main class="${"flex flex-col items-center text-text-primary"}"><h2 class="${"text-3xl text-center"}">ParallelCoin wallet application</h2>
            <p class="${"flex flex-wrap justify-center svelte-1jb77hl"}">${validate_component(Socials, "ButtonZoom").$$render($$result, {
      icon: "release.CustomFields.Icon",
      ":title": "release.Title",
      ":desc": "release.Content",
      ":url": "release.CustomFields.URL",
      ":key": "release.Slug"
    }, {}, {})}</p>
            <p class="${"flex flex-wrap justify-center svelte-1jb77hl"}">${validate_component(Socials, "ButtonZoom").$$render($$result, {
      icon: "release.CustomFields.Icon",
      ...
      ":key": "release.Slug"
            ...
            <h3 class="${"text-2xl text-center"}">ParallelCoin legacy wallet application</h3>
            <p class="${"flex flex-wrap justify-center svelte-1jb77hl"}">${validate_component(Socials, "ButtonZoom").$$render($$result, {
      icon: "legacy.CustomFields.Icon",
      ":title": "legacy.Title",
      ":desc": "legacy.Content",
      ":url": "legacy.CustomFields.URL",
      ":key": "legacy.Slug"
    }, {}, {})}</p>
            <p class="${"flex flex-wrap justify-center svelte-1jb77hl"}">${validate_component(Socials, "ButtonZoom").$$render($$result, {
      icon: "legacy.CustomFields.Icon",
  ...
  var Where = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    return `<div class="${"flex flex-col text-center md:container md:mx-auto md:px-0 parallelcoin"}">${validate_component(HeadTitle, "HeadTitle").$$render($$result, {}, {}, {
      default: () => `Where is ParallelCoin???`
    })}
        <div class="${"my-24 px-8 worp"}"><amp-list layout="${"responsive"}" width="${"600"}" height="${"300"}" src="${"https://api.parallelcoin.io/subs"}" reset-on-refresh items="${"."}" binding="${"no"}"><template type="${"amp-mustache"}"><a class="${"flex flex-row justify-center my-4 text-2xl no-underline text-light"}" href="${escape("https://{{ slug }}") + ".parallelcoin.info"}"><div class="${"character"}">${escape(`{{ title }}`)}</div>
            <div class="${"flex-grow hidden mx-1 mb-2 border-b-2 border-dotted md:flex"}"></div>
...
<div class="${"wrapper style0 first svelte-vnjlay"}"><article class="${"container svelte-vnjlay"}" id="${"top"}"><div class="${"row svelte-vnjlay"}"><div class="${"d4u svelte-vnjlay"}"><span class="${"image fit svelte-vnjlay"}"></span></div>
...
<div class="${"wrapper style2 svelte-vnjlay"}"><article id="${"work"}" class="${"svelte-vnjlay"}"><header class="${"svelte-vnjlay"}"><h2 class="${"svelte-vnjlay"}">Download</h2>
    ...
    <div class="${"container svelte-vnjlay"}"><div class="${"row svelte-vnjlay"}"><div class="${"d4u svelte-vnjlay"}"><section class="${"box style1 svelte-vnjlay"}"><span class="${"icon featured fa-windows svelte-vnjlay"}"></span>
            ...
            <a href="${"https://web.archive.org/web/20210702081625/https://github.com/p9c/pod/releases/download/1.2.0/Parallelcoin-qt-v1.2.0.0-Win.zip"}" target="${"_blank"}" class="${"svelte-vnjlay"}"><p class="${"svelte-vnjlay"}">Download Windows wallet.</p></a></section></div>
        <div class="${"d4u svelte-vnjlay"}"><section class="${"box style1 svelte-vnjlay"}"><span class="${"icon featured fa-linux svelte-vnjlay"}"></span>
            ...
            <a href="${"https://web.archive.org/web/20210702081625/https://github.com/p9c/pod/releases/download/1.2.0/parallelcoin-qt-x86_64.AppImage"}" target="${"_blank"}" class="${"svelte-vnjlay"}"><p class="${"svelte-vnjlay"}">Download QT wallet App Image.</p></a>
            <a href="${"https://web.archive.org/web/20210702081625/https://github.com/p9c/pod/releases/download/1.2.0/parallelcoind-x86_64.AppImage"}" target="${"_blank"}" class="${"svelte-vnjlay"}"><p class="${"svelte-vnjlay"}">Download daemon App Image.</p></a></section></div>
        <div class="${"d4u svelte-vnjlay"}"><section class="${"box style1 svelte-vnjlay"}"><span class="${"icon featured fa-github svelte-vnjlay"}"></span>
            ...
            <a href="${"https://web.archive.org/web/20210702081625/https://github.com/parallelcointeam/parallelcoin"}" target="${"_blank"}" class="${"svelte-vnjlay"}"><p class="${"svelte-vnjlay"}">View source on GitHub.</p></a></section></div></div></div>
...
<div class="${"wrapper style3 svelte-vnjlay"}"><article id="${"portfolio"}" class="${"svelte-vnjlay"}"><header class="${"svelte-vnjlay"}"><h2 class="${"svelte-vnjlay"}">Resources</h2>
    ...
    <div class="${"container svelte-vnjlay"}"><div class="${"row svelte-vnjlay"}"><div class="${"d4u svelte-vnjlay"}"><article class="${"box style2 svelte-vnjlay"}"><h3 class="${"svelte-vnjlay"}">Exchanges</h3>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://dex-trade.com/spot/trading/DUOBTC"}" target="${"_blank"}" class="${"svelte-vnjlay"}">Dex-Trade DUO-BTC</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://dex-trade.com/spot/trading/DUOUSDT"}" target="${"_blank"}" class="${"svelte-vnjlay"}">Dex-Trade DUO-USDT</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://c-patex.com/markets/duobtc"}" target="${"_blank"}" class="${"svelte-vnjlay"}">C-Patex DUO-BTC</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://c-patex.com/markets/duoltc"}" target="${"_blank"}" class="${"svelte-vnjlay"}">C-Patex DUO-LTC</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://c-patex.com/markets/duodoge"}" target="${"_blank"}" class="${"svelte-vnjlay"}">C-Patex DUO-DOGE</a></p></article></div>
        <div class="${"d4u svelte-vnjlay"}"><article class="${"box style2 svelte-vnjlay"}"><h3 class="${"svelte-vnjlay"}">Blockchain explorer</h3>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://explorer.parallelcoin.info/"}" target="${"_blank"}" class="${"svelte-vnjlay"}">ParallelCoin block explorer</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://prohashing.com/explorer/Parallelcoin/"}" target="${"_blank"}" class="${"svelte-vnjlay"}">Prohashing block explorer</a></p></article></div>

        <div class="${"d4u svelte-vnjlay"}"><article class="${"box style2 svelte-vnjlay"}"><h3 class="${"svelte-vnjlay"}">Faucet</h3>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://faucet.parallelcoin.info/"}" class="${"svelte-vnjlay"}">ParallelCoin Faucet</a></p></article></div></div>
      <div class="${"row svelte-vnjlay"}"><div class="${"d6u svelte-vnjlay"}"><article class="${"box style2 svelte-vnjlay"}"><h3 class="${"svelte-vnjlay"}">Pools</h3>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://pool.parallelcoin.info/"}" target="${"_blank"}" class="${"svelte-vnjlay"}">ParallelCoin SHA256 pool</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://duo.smarterhash.com/"}" target="${"_blank"}" class="${"svelte-vnjlay"}">Smarterhash</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://italyiimp.com/site/mining/"}" target="${"_blank"}" class="${"svelte-vnjlay"}">Italyiimp</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://duo.coinstop.me/"}" target="${"_blank"}" class="${"svelte-vnjlay"}">Coinstop</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://timeteh.com/"}" target="${"_blank"}" class="${"svelte-vnjlay"}">TimeTeh</a></p></article></div>
        <div class="${"d6u svelte-vnjlay"}"><article class="${"box style2 svelte-vnjlay"}"><h3 class="${"svelte-vnjlay"}">Market Information</h3>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://coinmarketcap.com/currencies/parallelcoin"}" target="${"_blank"}" class="${"svelte-vnjlay"}">Coinmarketcap</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://bitinfocharts.com/de/parallelcoin/"}" target="${"_blank"}" class="${"svelte-vnjlay"}">bitinfocharts</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://www.cryptocompare.com/coins/duo/overview"}" target="${"_blank"}" class="${"svelte-vnjlay"}">Cryptocompare</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://www.cryptocoincharts.info/coins/show/duo"}" target="${"_blank"}" class="${"svelte-vnjlay"}">Cryptocoincharts</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://www.coinhills.com/market/duo/"}" target="${"_blank"}" class="${"svelte-vnjlay"}">Coinhills</a></p>
            <p class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://www.blockchainstats.org/altcoin-market-data/parallelcoin-market-data/"}" target="${"_blank"}" class="${"svelte-vnjlay"}">Blockchainstats</a></p></article></div></div></div>
...
<div class="${"wrapper style4 svelte-vnjlay"}"><article id="${"contact"}" class="${"container 75% svelte-vnjlay"}"><header class="${"svelte-vnjlay"}"><h2 class="${"svelte-vnjlay"}">Have some question or suggestion?</h2>
    ...
    <div class="${"svelte-vnjlay"}">
      <div class="${"row svelte-vnjlay"}"><div class="${"d12u svelte-vnjlay"}"><hr class="${"svelte-vnjlay"}">
          ...
          <ul class="${"social svelte-vnjlay"}"><li class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://twitter.com/parallelcoinduo"}" class="${"icon fa-twitter svelte-vnjlay"}"><span class="${"label svelte-vnjlay"}">Twitter</span></a></li>
            <li class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://www.facebook.com/parallelcoin"}" class="${"icon fa-facebook svelte-vnjlay"}"><span class="${"label svelte-vnjlay"}">Facebook</span></a></li>
            </ul>
    ...
    <footer class="${"svelte-vnjlay"}"><ul id="${"copyright"}" class="${"svelte-vnjlay"}"><li class="${"svelte-vnjlay"}">\xA9 ParallelCoin - DUO. No rights reserved.</li></ul>
      <ul id="${"copyright"}" class="${"svelte-vnjlay"}"><li class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://marcetin.com/"}" class="${"svelte-vnjlay"}">marcetin</a></li>
        <li class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://bitstickers.net/"}" class="${"svelte-vnjlay"}">BitStickers</a></li>
        <li class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/https://anonstickers.shop/"}" class="${"svelte-vnjlay"}">AnonStickers</a></li>
        <li class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://com-http.us/"}" class="${"svelte-vnjlay"}">Crypto Currencies World</a></li>
        <li class="${"svelte-vnjlay"}"><a href="${"https://web.archive.org/web/20210702081625/http://com-http.org/"}" class="${"svelte-vnjlay"}">Webmaster Resource</a></li></ul></footer></article>
  <a href="${"#top"}" class="${"button big scrolly svelte-vnjlay"}">Top</a></div></div>


<div class="${"sc-kjoXOD kggkTh svelte-vnjlay"}"><div class="${"sc-jbKcbu buZDsR svelte-vnjlay"}"><amp-video poster="${"https://web.archive.org/web/20210702081625im_/https://parallelcoin.info/assets/poster.png"}" loop="${"loop"}" class="${"sc-hqyNC cnVHDz svelte-vnjlay"}" autoplay="${""}" id="${"bgVid"}" layout="${"flex-item"}" width="${"100vw"}" height="${"100vh"}"><source src="${"https://web.archive.org/web/20210702081625im_/https://parallelcoin.info/assets/grunge.mp4"}" type="${"video/mp4"}" class="${"svelte-vnjlay"}"></amp-video>
    <div class="${"buZDsRO svelte-vnjlay"}"></div></div>
  <div class="${"sc-bdVaJa gzDaIA svelte-vnjlay"}"><div class="${"sc-cHGsZl hAlYFz svelte-vnjlay"}"><figure class="${"svelte-vnjlay"}"></figure></div>
    <div class="${"sc-cHGsZl hAlYFz svelte-vnjlay"}">Soon!!!</div>
    <div class="${"sc-cHGsZl hAlYFz svelte-vnjlay"}">Plan 9 from crypto space!</div>
    <div style="${"position:relative"}" class="${"svelte-vnjlay"}"><div class="${"sc-iAyFgw datRyl svelte-vnjlay"}"><div class="${"sc-hSdWYo dUzKEk svelte-vnjlay"}"><div class="${"sc-eHgmQL fNmApF svelte-vnjlay"}"><div id="${"zoomUp"}" class="${"sc-cvbbAY eNBRGH svelte-vnjlay"}"><div class="${"sc-brqgnP jqSTTi svelte-vnjlay"}">Parallel</div>
              <div class="${"sc-cMljjf hJXFGi svelte-vnjlay"}">Coin</div></div>
            <div id="${"zoomDown"}" class="${"sc-jWBwVP eVdmWN svelte-vnjlay"}"><div class="${"sc-jAaTju iJXdPE svelte-vnjlay"}">DUO</div></div></div></div></div></div>
    <div class="${"sc-cHGsZl hAlYFz svelte-vnjlay"}">Hardfork to Go code!!!</div></div></div>`;
  });
  var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    const sub2 = getContext("sub");
    return `sub:${escape(sub2)} :I
${sub2 === "" ? `${validate_component(ParallelCoin, "ParallelCoin").$$render($$result, {}, {}, {})}` : ``}
