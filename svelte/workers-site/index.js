...
${``}`;
  ...
  function init(settings = default_settings) {
    ...
    options = {
      ...
      dev: false,
      entry: {
        file: assets + "/_app/start-16db84aa.js",
        css: [],
        js: [assets + "/_app/start-16db84aa.js", assets + "/_app/chunks/vendor-633de1bb.js"]
      },
      fetched: void 0,
      floc: false,
  ...
  var api_json = /* @__PURE__ */ Object.freeze({
    __proto__: null,
    [Symbol.toStringTag]: "Module"
  });
...
<div id="${"layout"}" class="${"relative flex flex-col items-center justify-between min-h-screen antialiased font-text text-text-primary "}">${validate_component(Bg, "Bg").$$render($$result, {}, {}, {})}
  ...
  async function fetchCoins() {
    return async function load2({ page, fetch: fetch2, session, context }) {
      const url = "https://api.parallelcoin.io/subs";
  ...
  var API = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    if ($$props.fetchCoins === void 0 && $$bindings.fetchCoins && fetchCoins !== void 0)
      $$bindings.fetchCoins(fetchCoins);
    return ``;
  });
  ...
  var Where = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    return `<div class="${"flex flex-col text-center parallelcoin"}">rrrrr
      ...
      default: () => `Where is ParallelCoin???`
        ...
        <div class="${"my-24 worp"}"><amp-list layout="${"responsive"}" width="${"600"}" height="${"300"}" src="${"https://api.parallelcoin.io/subs"}" reset-on-refresh single-item items="${"."}" binding="${"no"}">${escape(`{{ . }}`)}
...
${sub2 === "api" ? `${validate_component(API, "API").$$render($$result, {}, {}, {})}` : ``}
