...
${``}`;
  ...
  function init(settings = default_settings) {
    ...
    options = {
      ...
      dev: false,
      entry: {
        file: assets + "/_app/start-9314f2cc.js",
        css: [],
        js: [assets + "/_app/start-9314f2cc.js", assets + "/_app/chunks/vendor-f8a0085d.js"]
      },
      fetched: void 0,
      floc: false,
  ...
  var Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    return `<footer class="${"w-full py-2 text-center bg-dark text-body-1 "}"><span class="${"font-secondary"}">Built on the ParallelCoin ecosystem to display all the blockchain information.</span>
...
${sub !== "legacy" ? `<div id="${"layout"}" class="${"relative flex flex-col items-center justify-between min-h-screen antialiased font-text text-text-primary "}">${validate_component(Bg, "Bg").$$render($$result, {}, {}, {})}
    ${validate_component(Header, "Header").$$render($$result, {}, {}, {})}
    <main class="${"flex flex-col flex-1 w-full text-text-primary"}">${slots.default ? slots.default({}) : ``}</main>
    ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})}</div>` : `${slots.default ? slots.default({}) : ``}`}`;
  });
  ...
  var HeadTitle = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    ...
    return `<div class="${"relative flex flex-col justify-center"}"><div class="${"relative flex flex-col justify-center"}"><div class="${"absolute top-0 left-0 inline-block intro svelte-8x1o2q"}"><span class="${"intro intro--the svelte-8x1o2q"}">Plan 9</span>
      ...
      <h1 class="${"text-9xl font-title"}">${slots.default ? slots.default({}) : ``}</h1></div>
    </div>`;
  });
  var ParallelCoin = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    return `${$$result.head += `<script async custom-element="${"amp-script"}" src="${"https://cdn.ampproject.org/v0/amp-script-0.1.js"}" data-svelte="svelte-1333bxb"><\/script>`, ""}
  

<amp-script layout="${"container"}" src="${"https://s.okno.rs/parallelcoin/skrollr.js"}"><div id="${"skrollr-body"}"><div id="${"slide1"}" class="${"centered"}" data-0="${"display:block;"}" data-500="${"opacity:1;"}" data-2500="${"opacity:0;"}" data-2501="${"display:none;"}"><div id="${"poster"}"><div id="${"banner"}" data-0="${"background-color:rgba(48,48,48,1);"}" data-1000="${"background-color:rgba(48,48,48,0);"}"><div class="${"intro"}" data-0="${"transform:translateY(0vmin);"}" data-500="${"transform:translateY(3vmin);"}" data-1500="${"transform:translateY(-100vmin);"}"><span>Totally unstable coin from crypto space asimilate the coins and resurrect the dead!</span></div>
                    <h1 data-0="${"transform:translateY(0vmin);"}" data-500="${"transform:translateY(3vmin);"}" data-1500="${"transform:translateY(-100vmin);"}">Plan 9 from crypto space</h1>
                    <div id="${"credits"}" data-0="${"transform:translateY(0vmin);"}" data-500="${"transform:translateY(3vmin);"}" data-1500="${"transform:translateY(-100vmin);"}"><span>with</span>
                        ...
                        <p class="${"production"}">Produced by the people for the people</p></div></div>
                </div>

            <div id="${"posterimgs"}"><img src="${"https://s.okno.rs/parallelcoin/img/cover/cover-spaceship-c.png"}" id="${"spaceship"}" data-0="${"transform:translate(40%,320%) scale(0) rotate(60deg)"}" data-500="${"transform:translate(0%,100%) scale(1) rotate(0deg)"}" data-1500="${"transform:translate(-120%,-200%) scale(2) rotate(-30deg)"}">
            <img src="${"https://s.okno.rs/parallelcoin/img/cover/man-mono.png"}" id="${"man"}" data-0="${"transform:translate(0%,0%) scale3d(1,1,1);"}" data-1000="${"transform:translate(0%,0%) scale3d(1,1,1);"}" data-1500="${"transform:translate(-200%,200%) scale3d(0,1,1);"}">
            <img src="${"https://s.okno.rs/parallelcoin/img/cover/men-mono.png"}" id="${"men"}" data-0="${"opacity:1;transform:translateY(0%) scale3d(1,1,0.9)"}" data-900="${"opacity:1;transform:translateY(0%) scale3d(1,1,0.9)"}" data-1500="${"opacity:0;transform:translateY(-400%) scale3d(1,0,0.3)"}">


            <img src="${"https://s.okno.rs/parallelcoin/img/cover/vampira-mono.png"}" id="${"woman"}" data-0="${"transform:scale(1) translate(0%, 0%);opacity:1;"}" data-500="${"transform:scale(1) translate(0%, 100%);opacity:1;"}" data-1500="${"transform:scale(0) translate(-999%,-200% );opacity:0;"}"></div></div>


        <div id="${"slide2"}" class="${"centered"}" data-0="${"display:none;"}" data-1098="${"display:block;"}" data-10001="${"display:none;"}"><h2 data-0="${"display:none;"}" data-2799="${"display:block;"}" data-2800="${"opacity:0;font-size:64px;letter-spacing:33px;"}" data-4000="${"opacity:1;font-size:72px;letter-spacing:9px;"}" data-4800="${"opacity:0;font-size:64px;letter-spacing:33px;"}" data-4801="${"display:none;"}">New era is beginning</h2>
            <h2 data-5500="${"opacity:0;"}" data-6800="${"opacity:1;"}" data-8200="${"opacity:0;"}">Lets make the future from the past</h2>

            <img class="${"gophersr"}" src="${"https://s.okno.rs/img/go/gopher-space-rock.png"}" data-2500="${"right: -10%;transform: rotate(-30deg) scale(0,0)"}" data-3500="${"right: 10%;transform: rotate(-15deg) scale(0.3,0.2)"}" data-3900="${"right: 40%;transform: rotate(0deg) scale(0.8,0.9)"}" data-4200="${"right: 0%;transform: rotate(-15deg) scale(1,1)"}" data-5100="${"right:150%;"}">


            <img class="${"sgopher"}" src="${"https://s.okno.rs/img/go/space-gopher.png"}" data-1500="${"transform: translate(1000%,0) rotate(30deg) scale(0)"}" data-5800="${"transform: translate(-100%,0) rotate(-30deg) scale(1)"}">

            <img class="${"gopherhb"}" src="${"https://s.okno.rs/img/go/ee/heart-balloon.png"}" data-5000="${"right: -100%;"}" data-6000="${"right: 43%;"}" data-7000="${"right:43%;"}" data-9000="${"right:150%;"}">

            <img class="${"biker"}" src="${"https://s.okno.rs/img/go/biker.png"}" data-1500="${"transform:translate(-100%,40%);"}" data-4400="${"transform:translate(-100%,60%);"}" data-4500="${"transform:translate(1%,30%);"}" data-5000="${"transform:translate(200%,-20%);"}" data-7000="${"transform:translate(700%,-30%);"}" data-9000="${"transform:translate(1250%,80%);"}">

            <img class="${"gopherru"}" src="${"https://s.okno.rs/img/go/gopher-riding-unicorn.png"}" data-3000="${"transform:translate(1200%,10%) scale(0);"}" data-3500="${"transform:translate(900%,10%) scale(1);"}" data-4000="${"transform:translate(1100%,50%) scale(1);"}" data-6000="${"transform:translate(700%,50%) scale(1);"}" data-6500="${"transform:translate(650%,10%)  scale(1);"}" data-7500="${"transform:translate(-50%,-10%) scale(0);"}">

            <img class="${"ufo"}" src="${"https://s.okno.rs/parallelcoin/img/ufo.png"}" data-0="${"top: 2%; right: -20%; width:5%; transform: rotate(-50deg);"}" data-5500="${"top: 15%; right: 20%; width:10%; transform: rotate(30deg);"}" data-4500="${"top: 15%; right: 40%; width:5%; opacity:1; transform: rotate(-30deg);"}" data-6500="${"top: 5%; right: 60%; width:1%; opacity:.3; transform: rotate(-10deg);"}" data-9000="${"top: 30%; right:100%; width:15%; opacity:1; transform: rotate(10deg);"}">

            <span class="${"trees"}" data-0="${"transform:translate(-1%,800px);"}" data-3500="${"transform:translate(-1%,800px);"}" data-4500="${"transform:translate(-1%,0px);"}" data-9500="${"transform:translate(-50%,0px);"}" data-10000="${"transform:translate(-50%,800px);"}"></span>

            <span class="${"trees2"}" data-0="${"transform:translate(1%,500px);"}" data-3800="${"transform:translate(1%,500px);"}" data-4500="${"transform:translate(1%,-100px);"}" data-9500="${"transform:translate(-30%,-100px);"}" data-9800="${"transform:translate(-30%,500px);"}"></span>

            <span class="${"road"}" data-0="${"transform:translate(-1%,150px);"}" data-3500="${"transform:translate(-1%,150px);"}" data-4300="${"transform:translate(-1%,150px);"}" data-4500="${"transform:translate(-1%,1px);"}" data-9500="${"transform:translate(-80%,1px);"}" data-9600="${"transform:translate(-80%,150px);"}"></span></div>

        <div id="${"slide3"}" class="${"centered"}"><h2 data-9500="${"opacity:0; font-size:0vmax;"}" data-10500="${"opacity:1; font-size:5vmax;"}">Choose your way carefully!</h2>
<div class="${"centered logo"}" data-9000="${"width:0vmax; height:0vmax;"}" data-10000="${"width:48vmax; height:48vmax;"}"><img class="${"centered parallelcoin"}" src="${"https://s.okno.rs/parallelcoin/img/logo.svg"}" data-10000="${"width: 0vmax; height:0vmax;"}" data-10500="${"width:32vmax; height:48vmax;"}"></div>
            <a href="${"https://legacy.parallelcoin.info/"}" class="${"link legacy"}" data-10000="${"bottom:-100vmax;width: 0vmax; height:0vmax;"}" data-10500="${"bottom: 20vmax;width:12vmax; height:12vmax;"}"></a>
            <a href="${"https://parallelcoin.info/"}" class="${"link plan"}" data-10000="${"bottom:-100vmax;width: 0vmax; height:0vmax;"}" data-10500="${"bottom: 20vmax; width:12vmax; height:12vmax;"}"></a></div></div></amp-script>`;
  });
  ...
  var Download = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    return `${$$result.head += `<script async custom-element="${"amp-lightbox"}" src="${"https://cdn.ampproject.org/v0/amp-lightbox-0.1.js"}" data-svelte="svelte-zfcsi7"><\/script>`, ""}
...
${escape("{{/legacy}}")}</template></amp-list></div>`;
  ...
  var Where = create_ssr_component(($$result, $$props, $$bindings, slots) => {
    return `<div class="${"flex flex-col text-center md:container md:mx-auto md:px-0"}">${validate_component(HeadTitle, "HeadTitle").$$render($$result, {}, {}, {
